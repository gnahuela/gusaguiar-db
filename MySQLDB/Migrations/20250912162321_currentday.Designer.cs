...
namespace MySQLDB.Migrations
{
    ...
    [Migration("20250912162321_currentday")]
    partial class currentday
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MySQLDB.Entities.Campaign", b =>
                {
                    ...
                    b.Property<bool>("CurrentDayOnly")
            ...
            modelBuilder.Entity("MySQLDB.Entities.UserActivityBeliefThreshold", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CurrentTimeIndex")
                        .HasColumnType("int");

                    b.Property<string>("Hesitations")
                        .HasColumnType("json");

                    b.Property<string>("ManifestGoal")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("PerfectTimeFrameLabel")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");

                    b.Property<decimal?>("PerfectTimeFrameYears")
                    ...
                    b.ToTable("UserActivityBeliefThreshold");
                });
            ...
            modelBuilder.Entity("MySQLDB.Entities.UserActivityWhyAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId", "ActivityId", "AreaId", "LevelIndex")
                        .IsUnique()
                        .HasDatabaseName("IX_UserActivityWhyAnswer_UniqueResponse");

                    b.ToTable("UserActivityWhyAnswer");
                });
            ...
            modelBuilder.Entity("MySQLDB.Entities.UserMeditationRevelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TotalTimeMeditated")
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserMeditationRevelation");
                });
